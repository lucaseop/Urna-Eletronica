...
public class CadastrarGovernador extends JFrame{
	...
	public CadastrarGovernador(List<Candidato>governador){
		super("Cadastrar Governador");
		listacandidatos = governador;
		Container telagov = getContentPane();
		Manipulador objeto = new Manipulador();
		telagov.setLayout(null);
		setSize(300,250);
		...
		telagov.add(cadastrar);
	}
	
	public class Manipulador implements ActionListener{
		public void actionPerformed(ActionEvent evento){
			if(evento.getSource() == cadastrar){
				g = new Governador(caixaNome.getText(), caixaPartido.getText(), Integer.parseInt(caixaNumero.getText()));
